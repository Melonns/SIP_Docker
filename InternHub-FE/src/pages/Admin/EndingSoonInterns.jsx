...
const EndingSoonInterns = () => {
  ...
  const fetchEndingInterns = async () => {
    try {
      ...
      // Call API endpoint for ending soon interns (30 days)
      const res = await apiClient.get("/admin/interns/ending-soon", {
        params: {
          role,
          days: 30,
          page: currentPage,
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen px-4 md:px-8 py-8 font-sans text-slate-800 -mt-8">
      {/* Header */}
      <div className="mb-8 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Interns whose internship period will end within the next 30 days
          </p>
        </div>
      </div>
